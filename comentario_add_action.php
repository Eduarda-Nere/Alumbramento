  ...
  <?php include("menu_online.php"); ?>
    ...
    <?php
        ...
        try {
            ...
            $stmt = $dbh->prepare("insert into forum (comentario, isbn_livro) values (?,?);");
            $stmt->bindParam(1, $comentario);
            $stmt->bindParam(2, $isbn_livro);
            $comentario=$_POST["comentario"];
            $isbn_livro = $_SESSION["isbn_livro"];
            if($stmt->execute()) {
                ?>
                <br>
                ...
                <a href="livro.php" class="btn btn-main btn-theme" ><span class='bi-reply'></span>&nbsp;Voltar</a>   
                </div>
                <?php
            }

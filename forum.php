...
<html lang="pt-BR">
  ...
  <body class="blog_index" data-spy="scroll" data-target=".navbar-fixed-top" data-offset="100">
    ...
    <section class="blog-index">
        <div class="container">
            ...
            <div class="col-sm-8 contact-form-item wow zoomIn">
                    <input type="text" id="titulo" name="titulo" placeholder="Insira o nome do livro"required>
            </div>
            <div class="contact-form-item">
                <button type="submit" class="send_message btn btn-main btn-theme wow fadeInUp"><i class="fa fa-search"></i>&nbsp;&nbsp; Buscar</button>
            </div>
        </form><br>
    ...
    <br>
    <div class="contact-form-item">
        <a href="livro_add_form.php">
        <button type="submit" class="send_message btn btn-main btn-theme wow fadeInUp" name="cadastrar" id="cadastrar"><i class="fa fa-book"></i>&nbsp;&nbsp; Cadastrar livros </button></a>
    </div>

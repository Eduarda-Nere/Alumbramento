...
<div class="container">
    ...
    if(isset($_POST)) {
        ...
        try {
            ...
            $stmt = $dbh->prepare("insert into login (nome, email, senha) values (?,?,?);");
            ...
            ?>
                ...
                <a href="log-in.html" class="btn btn-main btn-theme" ><span class='bi-reply'></span>&nbsp;Login</a>   
                </div>
                <?php
            }
            ...
            echo '<p>Alguem já utilizou este email! Tente Novamente.</p>';
            echo '<hr>';
            echo '';
            echo "<a href='sign-up.html' class='btn btn-main btn-theme'><span class='bi-reply'></span>&nbsp;Voltar</a>";
            echo '</div>';

...
<div class="container">
    ...
    if(isset($_POST)) {
        ...
        try {
            ...
            $stmt = $dbh->prepare("insert into login (email, nome, senha, perfil) values (?,?,?,?);");
            ...
            if($stmt->execute()) {
                ...
                <a href="perfil_user.php" class="btn btn-main btn-theme" ><span class='bi-reply'></span>&nbsp;Voltar</a>   
                </div>
                <?php
            }
            ...
            echo '<hr>';
            echo '';
            echo "<a href='perfil_user.php' class='btn btn-main btn-theme'><span class='bi-reply'></span>&nbsp;Voltar</a>";
            echo '</div>';
